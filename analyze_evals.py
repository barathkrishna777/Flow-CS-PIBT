...
CATALOG = [
    ...
    ("evals/baselines/straight_epibt_512_setA.csv",    "Straight + CV-PIBT",    "A", 512),
    ("evals/v4b/flow_epibt_256_setA.csv",              "Flow v4b + CV-PIBT [256 st]", "A", 256),
    ("evals/v4b/flow_epibt_512_setA.csv",              "Flow v4b + CV-PIBT [512 st]", "A", 512),
    ...
    # Note: ORCA vel + CV-PIBT == Straight+CV-PIBT (same preferred vel); dropped.
    ...
    ("evals/v4/flow_epibt_256_setA.csv",               "Flow v4  + CV-PIBT [256 st]", "A_v4cmp", 256),
    ...
    ("evals/baselines/straight_epibt_512_setB.csv",    "Straight + CV-PIBT",    "B", 512),
    ("evals/v4b/flow_epibt_512_setB.csv",              "Flow v4b + CV-PIBT",          "B", 512),
    ...
    ("evals/baselines/straight_epibt_512_setC.csv",    "Straight + CV-PIBT",    "C", 512),
    ("evals/v4b/flow_epibt_512_setC.csv",              "Flow v4b + CV-PIBT",          "C", 512),
]
...
def print_ablation_summary(experiments):
    ...
    ABLATION = [
        ...
        ("A",       512, "Straight + CV-PIBT",     "CV-PIBT without learning"),
        ("A",       256, "Flow v4b + CV-PIBT [256 st]",  "Ours at 256 steps"),
        ("A",       512, "Flow v4b + CV-PIBT [512 st]",  "Ours at 512 steps"),
    ]
...
def write_markdown(experiments, output_path: str):
    ...
    ABLATION_ORDER = [
        ...
        ("A", 512, "Straight + CV-PIBT"),
        ("A", 256, "Flow v4b + CV-PIBT [256 st]"),
        ("A", 512, "Flow v4b + CV-PIBT [512 st]"),
    ]
